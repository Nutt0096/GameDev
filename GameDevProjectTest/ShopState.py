...
class ShopState:
    def __init__(self):
        ...
        self.bg_image = pygame.image.load("ShopBG.jpg")
        self.bg_image = pygame.transform.scale(self.bg_image, (WIDTH + 5, HEIGHT + 5))

        self.gob_img = pygame.image.load("Gob the Seller.png")
        self.gob_img = pygame.transform.scale(self.gob_img, (300, 300))

        self.gob_img_macho = pygame.image.load("Gob the Seller Macho2.png")
        self.gob_img_macho = pygame.transform.scale(self.gob_img_macho, (300, 300))

        self.font_4s = pygame.font.Font('Metamorphous-Regular.ttf', 12)
        self.font_sss = pygame.font.Font('Metamorphous-Regular.ttf', 16)
        self.font_ss = pygame.font.Font('Metamorphous-Regular.ttf', 20)
        self.font_s = pygame.font.Font('Metamorphous-Regular.ttf', 24)
        self.font_shop = pygame.font.Font('Metamorphous-Regular.ttf', 36)
        self.font_m = pygame.font.Font('Metamorphous-Regular.ttf', 48)
        self.font_l = pygame.font.Font('Metamorphous-Regular.ttf', 96)

        self.font_ss2 = pygame.font.Font('MedievalSharp-Regular.ttf', 20)
        self.font_s2 = pygame.font.Font('MedievalSharp-Regular.ttf', 24)
        self.font_shop2 = pygame.font.Font('MedievalSharp-Regular.ttf', 36)
        self.font_m2 = pygame.font.Font('MedievalSharp-Regular.ttf', 48)
        self.font_l2 = pygame.font.Font('MedievalSharp-Regular.ttf', 96)

        self.font_s3 = pygame.font.Font('CharlemagneStd-Bold.otf', 24)
        self.font_shop3 = pygame.font.Font('CharlemagneStd-Bold.otf', 36)
        self.font_m3 = pygame.font.Font('CharlemagneStd-Bold.otf', 48)
        self.font_l3 = pygame.font.Font('CharlemagneStd-Bold.otf', 96)

        self.money = 400  # get value instead when combined
        self.bought_items = []
        self.bought_weapons = []
        self.bought_spells = []
        self.bought_armors = []
    ...
    def render(self):
        ...
        pygame.draw.rect(self.screen, BLACK, pygame.Rect(60, 60, 600, 600), 2)

        # Item Panel
        s = pygame.Surface((600, 50), pygame.SRCALPHA)
        s.fill((255, 255, 0, 80))
        self.screen.blit(s, (60, 60))
        pygame.draw.rect(self.screen, BLACK, pygame.Rect(60, 60, 600, 50), 2)
        ...
        s = pygame.Surface((600, 50), pygame.SRCALPHA)
        s.fill((255, 0, 0, 80))
        self.screen.blit(s, (60, 60+150))
        pygame.draw.rect(self.screen, BLACK, pygame.Rect(60, 60+150, 600, 50), 2)
        ...
        s = pygame.Surface((600, 50), pygame.SRCALPHA)
        s.fill((0, 0, 255, 80))
        self.screen.blit(s, (60, 60 + 300))
        pygame.draw.rect(self.screen, BLACK, pygame.Rect(60, 60+300, 600, 50), 2)
        ...
        s = pygame.Surface((600, 50), pygame.SRCALPHA)
        s.fill((0, 0, 0, 80))
        self.screen.blit(s, (60, 60 + 450))
        pygame.draw.rect(self.screen, BLACK, pygame.Rect(60, 60+450, 600, 50), 2)
        ...
        for y in range(0, 4):
            for x in range(0, 4):
                pygame.draw.rect(self.screen, BLACK, pygame.Rect(125 + 130*x, 120 + 150*y, 80, 80), 2)
                if self.shop_list[y][x] is None:
                    # Cross
                    pygame.draw.line(self.screen, RED, (125 + 130*x, 120 + 150*y), (125 + 130*x + 80, 120 + 150*y + 80), 4)
                    pygame.draw.line(self.screen, RED, (125 + 130*x, 120 + 150*y + 80), (125 + 130*x + 80, 120 + 150*y), 4)
                else:
                ...
                if x == self.select_x and y == self.select_y:
                    pygame.draw.rect(self.screen, (200, 200, 0), pygame.Rect(125 + 130 * x, 120 + 150 * y, 80, 80), 4)

        # Gob Image
        if self.gob_dialogue and self.gob_dialogue_type == 1:
            self.screen.blit(self.gob_img_macho, (820, 60))
        else:
            self.screen.blit(self.gob_img, (820, 60))

        # Info Panel
        s = pygame.Surface((500, 260), pygame.SRCALPHA)
        s.fill((255, 255, 255, 200))
        self.screen.blit(s, (720, 400))
        pygame.draw.rect(self.screen, BLACK, pygame.Rect(720, 400, 500, 260), 2)
        ...
        self.screen.blit(money_text, text_rect)
        ...
        if self.confirm_window:
            pygame.draw.rect(self.screen, WHITE, pygame.Rect(WIDTH // 2 - 310, HEIGHT // 2 - 120, 620, 240))
            pygame.draw.rect(self.screen, BLACK, pygame.Rect(WIDTH // 2 - 310, HEIGHT // 2 - 120, 620, 240), 4)

            pygame.draw.rect(self.screen, BLACK, pygame.Rect(WIDTH // 2 - 300 + 40, HEIGHT // 2 - 120 + 160, 240, 60), 4)
            text = self.font_shop.render(f'Z : Confirm', False, BLACK)
            text_rect = text.get_rect(center=(WIDTH // 2 - 300 + 40 + 120, HEIGHT // 2 - 120 + 160 + 30))
            self.screen.blit(text, text_rect)

            pygame.draw.rect(self.screen, BLACK, pygame.Rect(WIDTH // 2 - 300 + 320, HEIGHT // 2 - 120 + 160, 240, 60),4)
        ...
        if self.gob_dialogue:
            # pygame.draw.rect(self.screen, WHITE, pygame.Rect(WIDTH // 2 - 300, HEIGHT // 2 - 50, 600, 100))
            s = pygame.Surface((500, 60), pygame.SRCALPHA)
            s.fill((255, 255, 255, 200))
            self.screen.blit(s, (720, 300))
            pygame.draw.rect(self.screen, BLACK, pygame.Rect(720, 300, 500, 60), 2)
